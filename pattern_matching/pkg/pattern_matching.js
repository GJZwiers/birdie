 ...
 * @returns {number}
 */
export function shift_and(pattern, text) {
  ...
  var ret = wasm.shift_and(ptr0, len0, ptr1, len1);
  return ret >>> 0;
}
...
export function kmp(pattern, text) {
  try {
    ...
    var len1 = WASM_VECTOR_LEN;
    wasm.kmp(retptr, ptr0, len0, ptr1, len1);
 ...
 * @returns {Uint32Array}
 */
export function horspool(pattern, text) {
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
    var ptr0 = passStringToWasm0(
      pattern,
    ...
    var len1 = WASM_VECTOR_LEN;
    wasm.horspool(retptr, ptr0, len0, ptr1, len1);
    var r0 = getInt32Memory0()[retptr / 4 + 0];
    var r1 = getInt32Memory0()[retptr / 4 + 1];
    var v2 = getArrayU32FromWasm0(r0, r1).slice();
    wasm.__wbindgen_free(r0, r1 * 4);
 ...
 * @returns {Uint32Array}
 */
export function bom(pattern, text) {
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
    var ptr0 = passStringToWasm0(
      pattern,
    ...
    var len1 = WASM_VECTOR_LEN;
    wasm.bom(retptr, ptr0, len0, ptr1, len1);
    var r0 = getInt32Memory0()[retptr / 4 + 0];
    var r1 = getInt32Memory0()[retptr / 4 + 1];
    var v2 = getArrayU32FromWasm0(r0, r1).slice();
    wasm.__wbindgen_free(r0, r1 * 4);
 ...
 * @returns {Uint32Array}
 */
export function bndm(pattern, text) {
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
    var ptr0 = passStringToWasm0(
      pattern,
    ...
    var len1 = WASM_VECTOR_LEN;
    wasm.bndm(retptr, ptr0, len0, ptr1, len1);
    var r0 = getInt32Memory0()[retptr / 4 + 0];
    var r1 = getInt32Memory0()[retptr / 4 + 1];
    var v2 = getArrayU32FromWasm0(r0, r1).slice();
    wasm.__wbindgen_free(r0, r1 * 4);
...
async function init(input) {
  if (typeof input === "undefined") {
    input = new URL("pattern_matching_bg.wasm", import.meta.url);
  }
  const imports = {};
  imports.wbg = {};
